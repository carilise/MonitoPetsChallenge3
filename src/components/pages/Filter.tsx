...
export default function Filter() {
  return (
    <div>
      {/* destop version  */}
      <div className="hidden md:block mt-8 max-w-[1500px] mx-auto px-8">
      ...
      <div className="block md:hidden mt-6 px-4">
        ...
        <div className="mb-4 flex items-between gap-6">
          <h2 className="text-xl font-bold text-[#003459]">Small Dog</h2>
          <p className="text-sm text-[#667479] mt-2">52 puppies</p>
        </div>
        ...
        <div className="flex justify-center px-4 py-8">
          <img src={paginates} alt="pagination" />
        </div>
      </div>
    </div>
  );
