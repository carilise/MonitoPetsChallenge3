...
const HeroDogsBanner = () => {
  return (
    <div>
      {/* version destop */}
      <div className="hidden md:block  mt-8 max-w-[1500px] mx-auto px-8 max-h-[378px] flex flex-col md:flex-row items-center justify-between">
      ...
      <div className="block md:hidden px-4 pt-6 pb-0">
        <div className="bg-[#FCEED5] rounded-lg">
          <div className="w-full max-w-[360px] mx-auto text-left ">
            ...
            <h2 className="text-[20px] font-[700] text-[#003459] mb-4">
              Thousands More Fun!
            </h2>
            <p className="text-[14px] text-secondary-300 font-[500] mb-6">
            ...
            <div className="flex flex-col gap-3">
              <button className="w-full border border-primary text-primary px-4 py-2 rounded-full flex items-center justify-center hover:bg-secondary hover:text-white transition">
                View Intro
                <MdOutlinePlayCircle className="ml-2 h-5 w-5" />
              </button>
              <Link
                to="/products"
                className="w-full bg-primary text-white px-4 py-2 rounded-full flex items-center justify-center hover:bg-white hover:text-primary transition"
              >
                Explore Now
              </Link>
            </div>
          ...
          {/* Image */}
          <div className="mt-3 w-full flex justify-center items-end relative z-0 overflow-hidden">
            <div className="absolute bottom-[-30px] h-[60%] w-full bg-primary-80 rotate-3 z-0" />

            <img
              src={HeroDogsImage}
              alt="dogs"
              className="h-[200px] w-full  rounded-xl relative z-10"
              style={{ borderRadius: "11.79px" }}
            />
          </div>
        </div>
